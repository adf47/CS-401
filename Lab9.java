...
public class Lab9  
{
	...
	{
		// Note that the variable is the interface type but the
		// object is MyDeqeue type.  This is legal because the
		// MyDeque class implements the SimpleDeque interface
	...
	// Note that the parameter is SimpleDeque. This means that any object
	// that implements the SimpleDeque interface can be passed into this
	// method.  We will see this more in other examples.
